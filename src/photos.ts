...
const photos = [
  ...
  { src: "image13.5f09a6e5.2400x1600.jpg", alt: "A man wearing a black jacket and backpack standing on a grass field during sunset" },
  ...
  { src: "image18.f533ed48.2400x356.jpg",  alt: "Green trees on a brown mountain under a blue sky during the daytime" },
